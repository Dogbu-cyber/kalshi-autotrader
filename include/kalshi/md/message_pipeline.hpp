...
namespace kalshi::md
{
  ...
  public:
     ...
     * @param logger Logger to emit diagnostics.
     * @param raw_sink Optional raw message sink.
     * @param include_raw_on_parse_error Include raw JSON on parse errors.
     * @param log_raw_messages Emit raw messages to logger.
     */
